...
const List<Map<String, dynamic>> spicyList = [
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: InkWell(
        ...
        borderRadius: BorderRadius.circular(20),
        onTap: () {
          Navigator.pushNamed(context, '/detail', arguments: pizza);
        },
        child: Column(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Container(
                    decoration: BoxDecoration(
                      // color: true ? Colors.green : Colors.red,
                        color: pizza.isVeg ? Colors.green : Colors.redAccent,
                  ...
                  Container(
                    decoration: BoxDecoration(
                        color: Colors.greenAccent.withOpacity(0.88),
                        borderRadius: BorderRadius.circular(30)),
                    child: Padding(
                      padding: const EdgeInsets.symmetric(
                          vertical: 4, horizontal: 8),
                      child: Text(
                        ...
                        style: TextStyle(
                            color: spicyList[pizza.spicy]['color'] ??
