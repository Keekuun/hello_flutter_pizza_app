              ...
              children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color:
                                containsNumber ? Colors.green : Colors.black38,
                          ),
                        ),
                      ],
                    ),
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color:
                                contains8Length ? Colors.green : Colors.black38,
                          ),
                        ),
                      ],
                    ),
                ...
                SizedBox(
                  ...
                  child: MyTextField(
                      ...
                      validator: (val) =>
                          checkPwdAgainValid(val, pwdController.text)),
                ),
                const SizedBox(height: 10),
                !signUpRequired
                    ? SizedBox(
  ...
  void _handleSignUp() {
    if (_formKey.currentState!.validate()) {
      ...
      setState(() {
        context
            .read<SignUpBloc>()
            .add(SignUpRequired(user, pwdController.text));
      });
    }
  }
}
